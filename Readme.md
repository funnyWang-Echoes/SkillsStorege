...
| `ppt-master` | 多角色协作式 PPT 生成系统，把 PDF/DOCX/URL/Markdown 转为 SVG 页面并导出 PPTX。 | 来源待确认；本次从本机 `C:\Users\funnyWang\.cc-switch\skills\ppt-master` 复制，公开 GitHub 搜索未确认到唯一仓库。 | 外部/他人 Skill，能力完整但待实测；需要补充准确 GitHub 来源后才算来源记录完整。 |
...
- `garden-skills/`：来源为 [ConardLi/garden-skills](https://github.com/ConardLi/garden-skills)，只保留其中 `gpt-image-2`、`kb-retriever`、`web-design-engineer`、`web-video-presentation` 到 `other-Skills/`。

## 后续待办

- 为 `ppt-master` 补充准确 GitHub 仓库链接、作者、License 和下载方式。
